...
export class DmlMigration1680255968306 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "user_info" (id, first_name, last_name, phone, address) 
                    VALUES ('50df86e2-ef02-4858-8c46-c80f8f4ccb54', 'admin', 'adminov', '+375336622189', 'amuratorskaya 4a')`
    )

    await queryRunner.query(
        `INSERT INTO "users" (email, password, status, role_id, role_type) 
                    VALUES ('admin@admin.com', '${await hashPassword('admin12345')}', true, 1, 'super-admin')`
          )
